...
// ref: https://programming-place.net/ppp/contents/c/rev_res/file000.html
...
int main(int argc, char **argv)
{
   ...
   double time_input_io, time_output_io, time_convert;
   ...
   if  (!existFile(outfilepath))
   {
      ...
      fprintf(fp, "input_io,convert,output_io\n");
   }
   else
   {
   ...
   fprintf(fp, "%f,%f,%f\n", time_input_io, time_convert, time_output_io);
