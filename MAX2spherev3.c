...
int main(int argc, char **argv) {
    ...
    //    FUV arr[params.frameheight][params.framewidth];

    // const int FH = params.frameheight;
    // const int FW = params.framewidth;
    // static FUV arr[FH][FW][4];
    ...
    if (fread(arr_read, sizeof(FUV), 2688 * 5376 * 4, fpread)<2688*5376*4){
        ...
        //    FUV arr_read[FH][FW];
        printf("%ld", fread(arr_read, sizeof(FUV), 2688 * 5376 * 4, fpread));
            ...
            for (ai = 0; ai < params.antialias; ai++) {
                ...
                for (aj = 0; aj < params.antialias; aj++) {
                    ...
                    if(!params.read){
                        ...
                        uv.u = arr_read[j][i][antinum].u;
                        uv.v=arr_read[j][i][antinum].v;
                    }
